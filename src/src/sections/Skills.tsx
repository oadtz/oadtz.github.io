...
export const Skills: React.FC<SectionProps> = ({ isNightMode }) => {
    return (
        <div className="flex flex-col items-center justify-center h-screen w-screen p-4 sm:p-8">
            <div className={`p-4 sm:p-8 rounded-lg border-4 shadow-lg max-w-4xl w-full max-h-[85vh] md:max-h-auto overflow-y-auto transition-colors duration-500 ${isNightMode
