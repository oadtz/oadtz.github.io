...
export const experience = [
  ...
  [
    "2020",
    "Senior Manager, Business Transformation & IS",
    "Aetna, a CVS Health Company",
  ],
  ["2019 - 2020", "IT Business Consultant", "Adastra Thailand"],
  [
    "2002 - 2018",
    "Engineering and Application Leadership",
    "Unilode, ExxonMobil, Softscape, Progress Information",
  ],
];
...
export const quickFacts = [
  ...
  [
    "Core positioning",
    "CTO, blockchain engineer, and product-minded builder for trusted digital infrastructure",
  ],
  [
    "Focus areas",
  ...
  [
    "Experience base",
    "20+ years across enterprise software, aviation, insurance, data platforms, public-sector blockchain, and water infrastructure",
  ],
];
